...
export const sourceEnemyDefinitions: SourceEnemyDefinition[] = [
  ...
  { name: "黑巾山賊", id: "e_starter_black_bandit", mapId: "starter-outskirts", physicalResistance: 0, magicResistance: 0, drops: [], elite: true, skill: "攔路突襲" },
