...
export const BOSS_ABILITY_SETS={
  e_lake_gale_altur:{shield:{name:'白虎盾',initialDelayMs:60_000,cooldownMs:60_000,durationMs:3_000,defenseBonus:.3},trueDamage:{name:'風碎',initialDelayMs:30_000,cooldownMs:30_000,damage:2_000}},
  e_japan_sea_golden_starfish:{regeneration:{name:'恢復術',initialDelayMs:60_000,cooldownMs:60_000,attackMultiplier:1.5,maxHpPerSecond:.005,durationMs:3_000},flame:{name:'火焰燎原',procChance:.3,attackMultiplier:1.8,burnAttackRatio:.15,burnDurationMs:6_000,maxStacks:3},curse:{name:'詛咒',initialDelayMs:60_000,cooldownMs:60_000,durationMs:8_000,attackReduction:.25,defenseReduction:.3,damageTakenIncrease:.15}},
