...
export function DungeonPanel({state,hero,party,dps=0,act,autoSkill,toggleAutoSkill,autoPotion,healingPotions,onAutoPotionChange,mapName,mapRegion,medicineQuickbar}:{state:DungeonState;mp:number;hero:CaravanMember;party:CaravanMember[];dps?:number;act:(action:DungeonAction,key?:DungeonKey)=>void;autoSkill:boolean;toggleAutoSkill:()=>void;autoPotion:AutoPotionSettings;healingPotions:HealingPotion[];onAutoPotionChange:(change:Partial<AutoPotionSettings>)=>void;mapName?:string;mapRegion?:string;medicineQuickbar?:ReactNode}){
