...
export function DungeonPanel({state,mp,hero,dps=0,act,mapName,mapRegion,medicineQuickbar}:{state:DungeonState;mp:number;hero:CaravanMember;dps?:number;act:(action:'start'|'normal'|'skill'|'retreat',key?:DungeonKey)=>void;mapName?:string;mapRegion?:string;medicineQuickbar?:ReactNode}){
