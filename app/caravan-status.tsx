...
type Props = {
  ...
  hero:CaravanMember; mercs:CaravanMember[]; active:string[]; toggleActive:(uid:string)=>void; gold:number; credit:number; creditXp:number; creditLevel:number; weight:number; maxWeight:number;
