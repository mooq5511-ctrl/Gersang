...
export type DungeonPartyMember={uid:string;name:string;templateId?:string;skill?:string;hp:number;maxHp:number;mp?:number;maxMp?:number;position:BattlePosition;defense?:number;attack?:number;accuracy?:number;attackInterval?:number};
