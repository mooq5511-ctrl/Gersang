...
export default function GameV15() {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      ...
      setGame(previous=>applyAutoPotionAction(settleCurrentGame(previous,rolls),addLog,grantXp));
    }, 50);
